...
export const LoginEmailVerification: React.FC = () => {
  ...
  const screen = useLoginEmailVerification();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {};
      await screen.continueWithCode(payload);
  ...
  return (
    <form onSubmit={handleSubmit}>
      <h1>LoginEmailVerification</h1>

      {/* TODO: Add form inputs for the 'continueWithCode' payload */}
