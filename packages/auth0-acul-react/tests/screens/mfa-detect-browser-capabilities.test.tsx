...
import * as MfaDetectBrowserCapabilitiesScreen from '../../src/screens/mfa-detect-browser-capabilities';
...
jest.mock('@auth0/auth0-acul-js/mfa-detect-browser-capabilities', () => {
...
describe('MfaDetectBrowserCapabilities Screen', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  describe('exports', () => {
    it('should export all context hooks', () => {
      expect(MfaDetectBrowserCapabilitiesScreen.useUser).toBeDefined();
      expect(MfaDetectBrowserCapabilitiesScreen.useTenant).toBeDefined();
      expect(MfaDetectBrowserCapabilitiesScreen.useBranding).toBeDefined();
      expect(MfaDetectBrowserCapabilitiesScreen.useClient).toBeDefined();
      expect(MfaDetectBrowserCapabilitiesScreen.useOrganization).toBeDefined();
      expect(MfaDetectBrowserCapabilitiesScreen.usePrompt).toBeDefined();
      expect(MfaDetectBrowserCapabilitiesScreen.useScreen).toBeDefined();
      expect(MfaDetectBrowserCapabilitiesScreen.useTransaction).toBeDefined();
      expect(MfaDetectBrowserCapabilitiesScreen.useUntrustedData).toBeDefined();
    });

    it('should export common hooks', () => {
      expect(MfaDetectBrowserCapabilitiesScreen.useCurrentScreen).toBeDefined();
      expect(MfaDetectBrowserCapabilitiesScreen.useErrors).toBeDefined();
      expect(MfaDetectBrowserCapabilitiesScreen.useAuth0Themes).toBeDefined();
    });
  });
  ...
  describe('instance hook', () => {
    it('should provide instance hook that returns screen instance', () => {
      ...
      const screenExports = Object.keys(MfaDetectBrowserCapabilitiesScreen);
      const potentialInstanceHooks = screenExports.filter(key => 
        ...
        key !== 'useResend' &&
        key !== 'useMfaPolling' &&
        typeof (MfaDetectBrowserCapabilitiesScreen as any)[key] === 'function'
      );
      ...
      potentialInstanceHooks.forEach(hookName => {
        try {
          ...
          const { result } = renderHook(() => (MfaDetectBrowserCapabilitiesScreen as any)[hookName]());
    ...
    it('should return stable reference across renders for instance hooks', () => {
      ...
      potentialInstanceHooks.forEach(hookName => {
        try {
          const { result, rerender } = renderHook(() => (MfaDetectBrowserCapabilitiesScreen as any)[hookName]());
          if (result.current && typeof result.current === 'object') {
  ...
  describe('submit functions', () => {
    it('should export submit functions if available', () => {
      ...
      submitFunctions.forEach(funcName => {
        expect(typeof (MfaDetectBrowserCapabilitiesScreen as any)[funcName]).toBe('function');
      });
    });
  });
  ...
  describe('utility hooks', () => {
    it('should export utility hooks if available', () => {
      ...
      const utilityHooks = screenExports.filter(key => 
        ...
        key !== 'useErrors' &&
        key !== 'useAuth0Themes' &&
        key !== 'useMfaDetectBrowserCapabilities'
      );
      
      // Each utility hook should be a function
      utilityHooks.forEach(hookName => {
        expect(typeof (MfaDetectBrowserCapabilitiesScreen as any)[hookName]).toBe('function');
      });
    });
    ...
    it('should call submit functions', () => {
      ...
      submitFunctions.forEach(funcName => {
        try {
          ...
          const func = (MfaDetectBrowserCapabilitiesScreen as any)[funcName];
