...
describe('ResetPasswordMfaWebauthnPlatformChallenge Screen', () => {
  ...
  const exports = categorizeScreenExports(ResetPasswordMfaWebauthnPlatformChallengeScreen);
  ...
  describe('exports', () => {
    it('should export all context hooks', () => {
      ...
      expect(ResetPasswordMfaWebauthnPlatformChallengeScreen.useExperiment).toBeDefined();
    });
