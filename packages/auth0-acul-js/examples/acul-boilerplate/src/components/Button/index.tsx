...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseClasses = 
    'flex items-center justify-center px-4 py-2 rounded-[var(--border-button-radius)] text-sm font-medium cursor-pointer h-10 transition-all duration-200 ease-linear shadow-sm hover:enabled:shadow-[inset_0_0_12.249px_rgba(0,0,0,0.08)]';
